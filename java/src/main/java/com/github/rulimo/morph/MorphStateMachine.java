...
import com.github.rulimo.morph.model.Rule;
import com.github.rulimo.morph.model.RuleItem;
import com.github.rulimo.morph.model.RuleMapping;
...
public class MorphStateMachine {
    ...
    static {
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(Configuration.getMorphStateMachinePath()), "utf-8"));
            try{
                String line = null;
